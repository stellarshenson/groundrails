...
- **Incumbent margin** - 0.71549 vs lettucedetect-v2's 0.6461 = **+0.0694**, 9/10 subsets on the 2-draw means; finqa remains the sole loss (0.6825 vs 0.7170 - numeric-derivation blindness, the known residual)
