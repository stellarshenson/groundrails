"""R8-H100 - full-scale run-to-run variance probe: verbatim R8-H90 replicate.
...
Run:  CUDA_DEVICE_ORDER=PCI_BUS_ID CUDA_VISIBLE_DEVICES=1 \
      uv run python experiments/grounding-semantic/R8-H100_dann_replicate.py
"""
...
CKPT_DIR = HERE.parent.parent / "models" / "R8-H100-mmbert-dann-replicate"
OUT = HERE / "R8-H100_result.json"
...
def main():
    ...
    print("=" * 96)
    print("R8-H100 RESULT - variance probe, verbatim H90 replicate")
    print("=" * 96)
